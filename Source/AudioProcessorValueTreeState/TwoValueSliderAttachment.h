...
#ifndef PHYSICAL_EDUCATION_TWOVALUESLIDERATTACHMENT_H
#define PHYSICAL_EDUCATION_TWOVALUESLIDERATTACHMENT_H

#include <JuceHeader.h>

/**
 * Hat tip: https://forum.juce.com/t/using-the-slider-attachment-class-with-2-value-sliders/18411
 */
    ...
    void sendInitialUpdate() {
        for (int i = 0; i < paramIDs.size(); ++i) {
            if (auto *v = state.getRawParameterValue(paramIDs[i])) {
                parameterChanged(paramIDs[i], v->load());
            }
        }
    }
...
public:
    ...
    ~TwoValueSliderAttachment() = default;
...
#endif //PHYSICAL_EDUCATION_TWOVALUESLIDERATTACHMENT_H
